...
def advance_session():
    ...
    advance_session.add_peer(1, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-1.fragment", 100, ("127.0.0.1", 48001), timeout=None)   #chunk 1,2  # 想要4
    advance_session.add_peer(2, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-2.fragment", 100, ("127.0.0.1", 48002), timeout=None)   #chunk 3,4
    advance_session.add_peer(7, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-3.fragment", 100, ("127.0.0.1", 48003), timeout=None)   #chunk 5,6  # 想要7,12
    advance_session.add_peer(14, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-4.fragment", 100, ("127.0.0.1", 48004), timeout=None)  #chunk 7,8
    advance_session.add_peer(10, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-5.fragment", 100, ("127.0.0.1", 48005), timeout=None)  #chunk 9,10  # 想要11
    advance_session.add_peer(15, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-6.fragment", 100, ("127.0.0.1", 48006), timeout=None)  #chunk 11,13,15
    advance_session.add_peer(12, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-7.fragment", 100, ("127.0.0.1", 48007), timeout=None)  #chunk 12,14,16
    advance_session.add_peer(13, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-8.fragment", 100, ("127.0.0.1", 48008), timeout=None)  #chunk 17,18,19,20  # 想要8,16
    ...
    while True:
        ...
        # if os.path.exists("test/tmp5/results/result1.fragment") or os.path.exists("test/tmp5/results/result2.fragment")\
        #      or os.path.exists("test/tmp5/results/result3.fragment") or os.path.exists("test/tmp5/results/result4.fragment"):
            success = True
            print(2)
            break
